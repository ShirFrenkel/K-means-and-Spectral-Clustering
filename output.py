...
def write_data_file(points, cluster_labels):
    """
        ...
        @post: writing to data.txt in the format mentioned in the assignment.
    """
    ...
    # the following statement will convert each point to a string and append to it the cluster label.
...
def write_clusters_file(spectral_tags, kmeans_tags, k):
    """
        ...
        @post: writing to clusters.txt in the format mentioned in the assignment.
    """
    ...
    for cluster in kmeans_for_print:
        string_to_print += ('\n' + cluster)
    f = open(config.CLUSTERS_TEXT_FILE_NAME, "w")
